...
class NoReinsurance_RiskOne:
    ...
    """
    def __init__(self, time, sim_maxstep, manager_args, brokers, syndicates, shareholders, risks, attrirional_losses, risk_model_configs, catastrophe_event, attritional_loss_event, broker_risk_event, broker_premium_event, broker_claim_event):
        """
        ...
        self.risks = risks
        self.attrirional_losses = attrirional_losses
